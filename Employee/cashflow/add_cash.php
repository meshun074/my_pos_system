	...
	<div class="contain h-100">
		...
		<div class="main">
			...
			<dir class="second_side">
					...
					<div class="text-left mt-5" style="margin-top: 20px;">
						<input type="hidden" name="username" value="<?php echo $_SESSION['username'];?>"/>
						<button type="submit" name="add_cashflow" class="btn btn-secondary"><i class="fas fa-check-circle"></i> Submit</button>
						<button class="btn btn-danger ml-2" onclick="window.location.href='../cashflow/cashflow.php'" ><i class="fas fa-ban"></i> Cancel</button>
					</div>
					<div class="text-left mt-4" style="margin-top: 20px;">						
					</div>
				</form>
			</dir>
		</div>
