...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../cashflow/cashflow.php'"><i class="fas fa-list-ul"></i> Cash Flow</button>
	<button id="sidebar_button" onclick="window.location.href='../cashflow/draw_invest.php'"><i class="fas fa-money-bill-alt"></i> Drawings & Investments</button>
	...
	<button id="sidebar_button" onclick="window.location.href='../cashflow/balance.php'" ><i class="fas fa-money-bill-alt"></i> Income Statement</button>
