		...
		<div class="modal-content text-center p-5">
			...
			<div class="modal-body mt-3">
				<div>
					...
					<input class="form-control-sm form-control" id="password-field1" type="password" name="confirmpass" placeholder="Confirm Password" required/><span toggle="#password-field1" class="fa fa-sm fa-eye ms-2 mt-3 toggle-password"></span></div>
