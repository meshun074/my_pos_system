			...
			<table class="table table-striped table-bordered" id="product_table" style="margin-top: -22px;">
				...
				<tbody class="table-hover">
					...
					<tr class="table-active">
						...
						<td>
							<button type="button" name="view" style='font-size:10px; border-radius:5px;padding:4px;' id="<?php echo $row['product_id'];?>" class="btn btn-success view_data"><i class="fas fa-eye"></i></button>
