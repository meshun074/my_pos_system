...
<div class="sidebar">
	...
	<button id="sidebar_button" onclick="window.location.href='../employee/salesreturn.php'"><i class="fas fa-cart-arrow-down"></i> Sales Return</button>
	...
	<button id="sidebar_button" type="button" data-toggle="popover" title="Cash Management" data-content="Here you can view sales and creditors of the store." data-placement="bottom"><i class="fas fa-question"></i> Help</button>
