...
<div class="modal fade modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-bs-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-fluid" role="document">
		<div class="modal-content" style="width:70%; margin-left: 20%;">
	  		<div class="admin_background modal-header ">
				<h4 class="modal-title " id="exampleModalCenterTitle" ><strong>Add New Customer</strong></h4>
	  	...
	  	<div class="modal-body">
			<div class="container-fluid">
				<form method="post" id="modal-form" action="../delivery/supplier_add.php" enctype="multipart/form-data" class="needs-validation">
		  			...
		  			<div align="center">
		  				...
		  				<img class="mb-1" width="150" height="150" src="../../images/people.png"/>
		  			</div>
		  				<small>
						...
						<div class="input-group mb-2"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-pen-alt"></i></span></div>		  				
		  				...
		  				<label>Choose Picture:<i class="fas fa-file-upload"></i></label><br><input type="file" class="form-control w-100" name="image" required/>
		  				</small>
			...
			<div class="modal-footer">
				<button type="button" class="admin_background btn btn-outline-warning" data-bs-dismiss="modal"><i class="fas fa-ban"></i> Cancel</button>
				<button  type="submit" name="submit" class="btn admin_background btn-warning" form="modal-form">Submit</button>
			</div>
		</div>
	</div>
</div>
