					...
					<table class="table-responsive mt-5 ">
						...
						<tbody>
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-building"></i></span></div><input type="text" name="com_name" pattern="[A-Za-z]+" title="Name must not contain numbers or spaces. e.g John12" class="form-control-sm form-control" placeholder="Enter Company Name" required></div></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="pl-5 pb-2"><div class="input-group"><div class="input-group-prepend"><span class="input-group-text" id="basic-addon1"><i class="fas fa-phone"></i></span></div><input type="text" title='Phone Number' class="form-control-sm form-control" name="number" placeholder="Enter Conctact Number" required></div></td>
							</tr>
						</tbody>
					</table>
