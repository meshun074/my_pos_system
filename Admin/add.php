...
<div class="modal fade bd-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-bs-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-fluid" role="document">
		<div class="modal-content" style="width:70%; margin-left: 20%;">
	  		<div class="modal-header " style="background-color: #0d0d0d; color: #D9A84E;">
	  	...
	  	<div class="modal-body ">
			<div class="container-fluid">
				<form method="post" id="modal-form" action="" enctype="multipart/form-data" class="needs-validation">
		  			...
		  			<div style="text-align:center">
		  				...
		  				<label>Choose Picture: <i class="fas fa-file-upload"></i></label><br><input type="file" class="ms-1 mt-2 w-75 form-control-sm" name="image" id="image1" required/>
		  				</small>
			...
			<div class="modal-footer">
				...
				<button id="submit_customer" style="background-color: #0d0d0d; color: #D9A84E;" type="button"  name="submit" class="btn btn-secondary" data-bs-dismiss="modal" form="modal-form">Submit</button>
			</div>
		</div>
	</div>
</div>
